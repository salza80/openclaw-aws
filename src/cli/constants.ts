...
export const API_PROVIDERS = [
  { title: 'Anthropic (Claude)', value: 'anthropic-api-key', description: 'Official Anthropic API (claude.ai)' },
  { title: 'OpenRouter', value: 'openrouter-api-key', description: 'Multi-provider API (100+ models)' },
  { title: 'OpenAI (GPT)', value: 'openai-api-key', description: 'Official OpenAI API' },
  { title:  'Gemini (Google)', value: 'gemini-api-key', description: 'Official Google API for Gemini models' },
  { title: 'AI Gateway', value: 'ai-gateway-api-key', description: 'AI Gateway API' },
  { title: 'Cloudflare AI Gateway', value: 'cloudflare-ai-gateway-api-key', description: 'Cloudflare AI Gateway API' },
