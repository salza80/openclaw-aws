...
export class OpenClawStack extends Stack {
  constructor(scope: Construct, id: string, props: OpenClawStackProps) {
    ...
    userData.addCommands(
      ...
      `sudo -H -u ubuntu GATEWAY_TOKEN="${gatewayToken}" python3 << 'PYTHON_SCRIPT'`,
      'import json',
      'import os',
      ...
      '    print("Configured gateway with authentication token")',
      'else:',
      '    print("WARNING: OpenClaw config not found. Onboarding may have failed.")',
      'PYTHON_SCRIPT',
      '',
